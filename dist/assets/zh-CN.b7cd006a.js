...
var t = (F, u, e) =>
    u in F ? o(F, u, { enumerable: !0, configurable: !0, writable: !0, value: e }) : (F[u] = e),
  a = (F, u) => {
    for (var e in u || (u = {})) l.call(u, e) && t(F, e, u[e])
    if (E) for (var e of E(u)) c.call(u, e) && t(F, e, u[e])
    return F
  },
  r = (F, u) => C(F, A(u))
import { g as i } from './helper.0e0cb643.js'
import { z as s } from './index.c83f165b.js'
const B = {
    okText: '\u786E\u8BA4',
    closeText: '\u5173\u95ED',
    cancelText: '\u53D6\u6D88',
  ...
  T = Object.assign({
    ...
    './zh-CN/routes/system.ts': p,
  }),
  x = { message: r(a({}, i(T, 'zh-CN')), { zhCn: s }) }
export { x as default }
