...
import { E as hr } from './el-button.a68b4578.js'
var Q = { exports: {} }
function dr(P) {
  throw new Error(
...
const br = or({
  ...
  setup(P) {
    function L() {
      console.log('search', Q.exports.encrypt, Q.exports.decrypt)
    }
    return (H, B) => {
      const A = sr('eli-svg-icon'),
        b = hr
      return (
        cr(),
        fr(
          ...
          { default: vr(() => [ur(A, { name: 'search', width: '20px', height: '20px' })]), _: 1 },
        )
      )
    }
  },
