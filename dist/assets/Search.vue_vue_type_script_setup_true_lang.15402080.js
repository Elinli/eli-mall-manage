...
import { E as hr } from './el-button.42d22c5b.js'
var Y = { exports: {} }
function dr(P) {
  throw new Error(
          ...
          var H =
            ...
            (function (B, A) {
              ...
              if (
                ...
                !b && typeof L != 'undefined' && L.crypto && (b = L.crypto),
...
const br = or({
  ...
  setup(P) {
    ...
    return (H, B) => {
      const A = ur('eli-svg-icon'),
        b = hr
      return (
        sr(),
        cr(
          b,
          { class: 'search icon-button', text: '', onClick: K },
          { default: fr(() => [vr(A, { name: 'search', width: '20px', height: '20px' })]), _: 1 },
        )
      )
    }
  },
