...
var W = (r, t, e) =>
  ...
  E = (r, t) => {
    for (var e in t || (t = {})) bt.call(t, e) && W(r, e, t[e])
    if (U) for (var e of U(t)) vt.call(t, e) && W(r, e, t[e])
    return r
  },
  _ = (r, t) => dt(r, gt(t))
import { l as pt, u as G, E as q, _ as et } from './index.1cf455db.js'
import {
  h as rt,
  i as u,
  j as F,
...
import { i as Y } from './icon.52d45ae7.js'
const ot = Symbol('buttonGroupContextKey'),
  _t = ({ from: r, replacement: t, scope: e, version: a, ref: o, type: n = 'API' }, s) => {
    rt(
      () => u(s),
      (i) => {},
      { immediate: !0 },
  ...
  $t = { prefix: Math.floor(Math.random() * 1e4), current: 0 },
  Vt = Symbol('elIdInjection'),
  Ct = (r) => {
    const t = F(Vt, $t)
    return y(() => u(r) || `el-id-${t.prefix}-${t.current++}`)
  },
  Pt = () => {
    const r = F(yt, void 0),
      t = F(mt, void 0)
  ...
  de = (r, { formItemContext: t, disableIdGeneration: e, disableIdManagement: a }) => {
    e || (e = R(!1)), a || (a = R(!1))
    const o = R()
    let n
    const s = y(() => {
    ...
    return (
      kt(() => {
        n = rt(
          [P(r, 'id'), e],
          ([i, c]) => {
            const d = i != null ? i : c ? void 0 : Ct().value
            d !== o.value &&
              (t != null &&
                t.removeInputId &&
                (o.value && t.removeInputId(o.value),
                !(a != null && a.value) && !c && d && t.addInputId(d)),
              (o.value = d))
          },
          { immediate: !0 },
        )
  ...
  zt = ['default', 'primary', 'success', 'warning', 'info', 'danger', 'text', ''],
  jt = ['button', 'submit', 'reset'],
  z = wt({
    size: xt,
    disabled: Boolean,
    type: { type: String, values: zt, default: '' },
    icon: { type: Y, default: '' },
    nativeType: { type: String, values: jt, default: 'button' },
    loading: Boolean,
    loadingIcon: { type: Y, default: () => pt },
    plain: Boolean,
    text: Boolean,
    link: Boolean,
    bg: Boolean,
  ...
  Gt = { click: (r) => r instanceof MouseEvent }
function l(r, t) {
  Dt(r) && (r = '100%')
  var e = Ot(r)
  return (
...
function Z(r, t, e) {
  ...
  if (a === o) (s = 0), (n = 0)
    ...
    var c = a - o
    switch (((s = i > 0.5 ? c / (2 - a - o) : c / (a + o)), a)) {
      case r:
        n = (t - e) / c + (t < e ? 6 : 0)
        break
      case t:
...
function Wt(r, t, e) {
  var a, o, n
  if (((r = l(r, 360)), (t = l(t, 100)), (e = l(e, 100)), t === 0)) (o = e), (n = e), (a = e)
  else {
    var s = e < 0.5 ? e * (1 + t) : e + t - e * t,
      i = 2 * e - s
    ;(a = $(i, s, r + 1 / 3)), (o = $(i, s, r)), (n = $(i, s, r - 1 / 3))
  }
...
function qt(r, t, e) {
  ...
  var a = Math.floor(r),
    ...
    w = [i, e, e, s, n, n][c],
    M = [n, n, i, e, e, s][c]
  return { r: d * 255, g: w * 255, b: M * 255 }
}
function X(r, t, e, a) {
  var o = [
...
function Yt(r) {
  ...
  return (
    ...
    typeof r == 'object' &&
      (b(r.r) && b(r.g) && b(r.b)
        ? ((t = Ut(r.r, r.g, r.b)), (s = !0), (i = String(r.r).substr(-1) === '%' ? 'prgb' : 'rgb'))
        : b(r.h) && b(r.s) && b(r.v)
        ? ((a = I(r.s)), (o = I(r.v)), (t = qt(r.h, a, o)), (s = !0), (i = 'hsv'))
        : b(r.h) &&
          b(r.s) &&
          b(r.l) &&
          ((a = I(r.s)), (n = I(r.l)), (t = Wt(r.h, a, n)), (s = !0), (i = 'hsl')),
...
var Zt = '[-\\+]?\\d+%?',
  Qt = '[-\\+]?\\d*\\.\\d+%?',
  m = '(?:'.concat(Qt, ')|(?:').concat(Zt, ')'),
  V = '[\\s|\\(]+('.concat(m, ')[,|\\s]+(').concat(m, ')[,|\\s]+(').concat(m, ')\\s*\\)?'),
  C = '[\\s|\\(]+('
    .concat(m, ')[,|\\s]+(')
    .concat(m, ')[,|\\s]+(')
    .concat(m, ')[,|\\s]+(')
...
var te = (function () {
  function r(t, e) {
    ...
    typeof t == 'number' && (t = Jt(t)), (this.originalInput = t)
    var o = Yt(t)
  ...
  return (
    ...
    (r.prototype.setAlpha = function (t) {
      return (this.a = it(t)), (this.roundA = Math.round(100 * this.a) / 100), this
    }),
    ...
    (r.prototype.toHex = function (t) {
      return t === void 0 && (t = !1), X(this.r, this.g, this.b, t)
    }),
    ...
    (r.prototype.toName = function () {
      ...
      for (
        var t = '#' + X(this.r, this.g, this.b, !1), e = 0, a = Object.entries(j);
        e < a.length;
        e++
      ) {
        var o = a[e],
    ...
    (r.prototype.lighten = function (t) {
      t === void 0 && (t = 10)
      var e = this.toHsl()
      return (e.l += t / 100), (e.l = A(e.l)), new r(e)
    }),
    ...
    (r.prototype.desaturate = function (t) {
      t === void 0 && (t = 10)
      var e = this.toHsl()
      return (e.s -= t / 100), (e.s = A(e.s)), new r(e)
    }),
...
function ee(r) {
  ...
  return y(() => {
    ...
    if (o) {
      const n = new te(o),
        s = r.dark ? n.tint(20).toString() : v(n, 20)
      if (r.plain)
        (a = e.cssVarBlock({
          'bg-color': r.dark ? v(n, 90) : n.tint(90).toString(),
          'text-color': o,
          'border-color': r.dark ? v(n, 50) : n.tint(50).toString(),
        ...
        const i = r.dark ? v(n, 30) : n.tint(30).toString(),
          c = n.isDark()
        ...
        if (
          ...
          const d = r.dark ? v(n, 50) : n.tint(50).toString()
...
const re = ['aria-disabled', 'disabled', 'autofocus', 'type'],
  ae = { name: 'ElButton' },
  ne = nt(
    _(E({}, ae), {
      props: z,
      ...
      setup(r, { expose: t, emit: e }) {
        ...
        const n = F(ot, void 0),
          ...
          i = G('button'),
          { form: c } = Pt(),
          d = At(y(() => (n == null ? void 0 : n.size))),
          w = at(),
          M = R(),
          D = y(() => a.type || (n == null ? void 0 : n.type) || ''),
          ft = y(() => {
            var f, k, x
            return (x =
          ...
          O = y(() => {
            ...
            if (ft.value && (k == null ? void 0 : k.length) === 1) {
              const x = k[0]
              if ((x == null ? void 0 : x.type) === It) {
                const lt = x.children
          ...
          ut = ee(a),
          ct = (f) => {
            a.nativeType === 'reset' && (c == null || c.resetFields()), e('click', f)
          }
        return (
          t({ ref: M, size: d, type: D, disabled: w, shouldAddSpace: O }),
          (f, k) => (
            p(),
            H(
              'button',
              ...
              [
                      ...
                      [
                        f.$slots.loading
                          ...
                          : (p(),
                            B(
                              u(q),
                              { key: 1, class: N(u(i).is('loading')) },
                              { default: K(() => [(p(), B(L(f.loadingIcon)))]), _: 1 },
                              8,
                              ['class'],
                            )),
                      ],
                ...
                f.$slots.default
                  ? (p(),
                    H(
                      'span',
                      { key: 2, class: N({ [u(i).em('text', 'expand')]: u(O) }) },
                      [T(f.$slots, 'default')],
                      2,
                    ))
                  : J('v-if', !0),
...
const ie = { size: z.size, type: z.type },
  se = { name: 'ElButtonGroup' },
  fe = nt(
    _(E({}, se), {
      props: ie,
      setup(r) {
        const t = r
        Tt(ot, Nt({ size: P(t, 'size'), type: P(t, 'type') }))
        const e = G('button')
        return (a, o) => (
          p(), H('div', { class: N(`${u(e).b('group')}`) }, [T(a.$slots, 'default')], 2)
        )
      },
    }),
  )
...
const ge = Ft(oe, { ButtonGroup: st })
Et(st)
export { ge as E, te as T, _t as a, Pt as b, de as c, Ct as u }
