...
function s1(e, t, s = {}) {
  ...
  return a && ((r.value = !0), m && w()), J(v), { isPending: r, start: w, stop: v }
}
const R = (e) => e === void 0,
...
/*! Element Plus Icons Vue v2.0.9 */ var d = (e, t) => {
    let s = e.__vccOpts || e
...
var h1 = d(S2, [
  ...
  Z2 = [T2]
function H2(e, t, s, a, r, o) {
  return i(), c('svg', I2, Z2)
}
var v1 = d(D2, [
    ['render', H2],
  ...
  G2 = [U2]
function J2(e, t, s, a, r, o) {
  return i(), c('svg', b2, G2)
}
var w1 = d(O2, [
    ['render', J2],
...
var B1 = d(A0, [
  ...
  D0 = [k0]
function I0(e, t, s, a, r, o) {
  return i(), c('svg', P0, D0)
}
var M1 = d(F0, [
  ['render', I0],
...
const T0 = 'el',
  ...
  H0 = (e) => {
    ...
    return {
      ...
      cssVar: (n) => {
        const _ = {}
        for (const u in n) n[u] && (_[`--${s.value}-${u}`] = n[u])
        return _
      },
      cssVarName: (n) => `--${s.value}-${n}`,
      cssVarBlock: (n) => {
        const _ = {}
        for (const u in n) n[u] && (_[`--${s.value}-${e}-${u}`] = n[u])
        return _
      },
...
const b0 = T({ size: { type: Z([Number, String]) }, color: { type: String } }),
      ...
      setup(e) {
        const t = e,
          ...
          a = B(() =>
            !t.size && !t.color
              ? {}
              : { fontSize: R(t.size) ? void 0 : q(t.size), '--color': t.color },
          )
        return (r, o) => (
          i(), c('i', b({ class: f(s).b(), style: f(a) }, r.$attrs), [O(r.$slots, 'default')], 16)
        )
      },
    }),
  )
